...
impl bindgen::callbacks::ParseCallbacks for CamelCaseConverterCallback {
    ...
    fn item_name(&self, original_item_info: bindgen::callbacks::ItemInfo) -> Option<String> {
        let original_item_name = original_item_info
            .name
            .strip_prefix("SANE_")
            .unwrap_or(original_item_info.name);
